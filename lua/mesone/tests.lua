...
function M:_set_keymaps()
  ...
  vim.api.nvim_buf_set_keymap(self.buf, "n", "<enter>", "", {
    ...
    noremap = true,
    silent = true,
    callback = function() self:_goto_test() end
  })
  vim.api.nvim_buf_set_keymap(self.buf, "n", "r", "", {
    nowait = true,
    noremap = true,
    silent = true,
    callback = function() self:_run_test() end
  })
  vim.api.nvim_buf_set_keymap(self.buf, "n", "d", "", {
    nowait = true,
    noremap = true,
    silent = true,
    callback = function() self:_debug_test() end
  })
  vim.api.nvim_buf_set_keymap(self.buf, "n", "R", "", {
    nowait = true,
    noremap = true,
    silent = true,
    callback = function() self:_run_all_tests() end
  })
  vim.api.nvim_buf_set_keymap(self.buf, "n", "l", "", {
    nowait = true,
    noremap = true,
    silent = true,
    callback = function() self:_log_test() end
  })
end
...
function M:_get_selected()
  ...
  if vim.tbl_isempty(self.test_links[r]) then return nil end
